...
{
	MYLOG("addr@%lx page %lx off %u state %x", base_address, page, offset, state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states));
	...
	{
		uint32_t state_index = state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states);
...
{
	MYLOG("addr@%lx state %x act_idx %u act %d", address, state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), action_index, Actions[action_index]);
	stats.track.called++;
	...
	if(prefetch_tracker.size() >= knob::scooby_pt_size)
	{
		...
		MYLOG("victim_state %x victim_act_idx %u victim_act %d", ptentry->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), ptentry->action_index, Actions[ptentry->action_index]);
		if(last_evicted_tracker)
		{
			MYLOG("last_victim_state %x last_victim_act_idx %u last_victim_act %d", last_evicted_tracker->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), last_evicted_tracker->action_index, Actions[last_evicted_tracker->action_index]);
			/* train the agent */
...
void Scooby::reward(uint64_t address)
{
	...
	for(uint32_t index = 0; index < ptentries.size(); ++index)
	{
		...
		MYLOG("PT hit. state %x act_idx %u act %d", ptentry->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), ptentry->action_index, Actions[ptentry->action_index]);
...
{
	MYLOG("reward PT evict %lx state %x act_idx %u act %d", ptentry->address, ptentry->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), ptentry->action_index, Actions[ptentry->action_index]);
...
{
	MYLOG("assign_reward PT evict %lx state %x act_idx %u act %d", ptentry->address, ptentry->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), ptentry->action_index, Actions[ptentry->action_index]);
	assert(!ptentry->has_reward);
...
void Scooby::train(Scooby_PTEntry *curr_evicted, Scooby_PTEntry *last_evicted)
{
	...
	{
		brain->learn(
			last_evicted->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), 
			last_evicted->action_index, 
			last_evicted->reward, 
			curr_evicted->state->value(knob::scooby_state_type, knob::scooby_state_hash_type, knob::scooby_max_states), 
			curr_evicted->action_index
			);
	}
	MYLOG("train done");
}
