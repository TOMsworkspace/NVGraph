...
const char* PolicyString[] = {"InvalidPolicy", "EGreddy", "Directly"};
...
const char* LearningTypeString[] = {"InvalidLearningType", "QLearning", "SARSA"};
...
Policy LearningEngineBase::parsePolicy(std::string str)
{
	...
	if(!str.compare("Directly"))		return Policy::Directly;
