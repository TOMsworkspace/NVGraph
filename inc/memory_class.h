...
// CACHE ACCESS TYPE
#define LOAD      0
#define RFO       1  //read  for  ownership
#define PREFETCH  2
#define WRITEBACK 3
#define NUM_TYPES 4

extern uint32_t DRAM_tRP,  // DRAM Row Precharge (RP) latency
                DRAM_tRCD, // DRAM Row address to Column address (RCD) latency
                DRAM_tCAS; // DRAM Column Address Strobe (CAS) latency

extern uint32_t NVM_tRP,  // NVM Row Precharge (RP) latency
                NVM_tRCD, // NVM Row address to Column address (RCD) latency
                NVM_tCAS; // NVM Column Address Strobe (CAS) latency

extern uint32_t HMM_NVM_tRP,  // NVM Row Precharge (RP) latency
                HMM_NVM_tRCD, // NVM Row address to Column address (RCD) latency
                HMM_NVM_tCAS; // NVM Column Address Strobe (CAS) latency
